...
internal sealed class AsyncPromptHandler<TModule, TData>(MethodInfo method, PromptAttribute<TData> attribute) : ModuleHandlerBase<TModule> where TModule : ModuleBase where TData : IParsable<TData>
{
    private readonly Func<TModule, PromptStateContext<TData>, Task<StateResult>> _expression = method.CreateDelegate<Func<TModule, PromptStateContext<TData>, Task<StateResult>>>();
