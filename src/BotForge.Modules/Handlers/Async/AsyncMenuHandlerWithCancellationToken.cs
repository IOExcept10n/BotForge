...
internal sealed class AsyncMenuHandlerWithCancellationToken<TModule>(MethodInfo method, ILabelStore labelStore, IEnumerable<MenuRowAttribute> buttonRows) : ModuleHandlerBase<TModule> where TModule : ModuleBase
{
