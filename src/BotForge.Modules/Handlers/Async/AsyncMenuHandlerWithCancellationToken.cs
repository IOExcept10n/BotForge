...
internal class AsyncMenuHandlerWithCancellationToken<TModule>(MethodInfo method, ILabelStore labelStore) : ModuleHandlerBase<TModule> where TModule : ModuleBase
{
